...
def gyro():
    ...
    content = "<h3>Gyro x : " + str(gyroskop_xout) + "</h3>"
    content += "<h3>Gyro y : " + str(gyroskop_yout) + "</h3>"
    content += "<h3>Gyro z : " + str(gyroskop_zout) + "</h3>"
    ...
    content += "<h3>Gyro3 x : " + str(beschleunigung_xout_skaliert) + "</h3>"
    content += "<h3>Gyro3 y : " + str(beschleunigung_yout_skaliert) + "</h3>"
    content += "<h3>Gyro3 z : " + str(beschleunigung_zout_skaliert) + "</h3>"
    with open("elore2.txt", "a") as f:
